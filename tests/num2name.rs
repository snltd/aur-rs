...
mod test {
    ...
    fn test_num2name_command() {
        ...
        assert_cli::Assert::main_binary()
            .with_args(&["num2name", &file_under_test.to_string_lossy()])
            .succeeds()
            .and()
            .stdout()
        ...
        assert_cli::Assert::main_binary()
            .with_args(&["num2name", &renamed_file.to_string_lossy()])
            .succeeds()
            .and()
            .stdout()
            .is("")
    ...
    fn test_num2name_command_bad_file() {
        assert_cli::Assert::main_binary()
            .with_args(&["num2name", &fixture_as_string("info/bad_file.flac")])
            .fails()
            .and()
            .stderr()
